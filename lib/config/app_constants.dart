...
ThemeData lightTheme = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    displaySmall: TextStyle(color: primaryTextColorLight, fontFamily: 'TT Hoves', fontWeight: FontWeight.bold, fontSize: 14),
    ...
    labelMedium: TextStyle(color: primaryTextColorLight, fontFamily: 'TT Hoves', fontWeight: FontWeight.bold, fontSize: 12),
    labelSmall: TextStyle(color: primaryTextColorLight, fontFamily: 'TT Hoves', fontWeight: FontWeight.w500, fontSize: 10),
  ),
);
...
ThemeData darkTheme = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    displaySmall: TextStyle(color: primaryTextColorDark, fontFamily: 'TT Hoves', fontWeight: FontWeight.bold, fontSize: 14),
    ...
    labelMedium: TextStyle(color: primaryTextColorDark, fontFamily: 'TT Hoves', fontWeight: FontWeight.bold, fontSize: 12),
    labelSmall: TextStyle(color: primaryTextColorDark, fontFamily: 'TT Hoves', fontWeight: FontWeight.w500, fontSize: 10),
  ),
);
